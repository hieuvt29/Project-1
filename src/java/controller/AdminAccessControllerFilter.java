...
public class AdminAccessControllerFilter implements Filter {
    ...
    public AdminAccessControllerFilter() {
    }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("AdminAccessControllerFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("AdminAccessControllerFilter()");
        }
        StringBuffer sb = new StringBuffer("AdminAccessControllerFilter(");
