...
//            submitBtn.attr('disabled', true);
            ...
            var check_email_timer, check_pass_timer,
                    email_ok = true, pass_ok = true;

            function submitController() {

                if (email_ok && pass_ok && $('input[name="user_phonenumber"').val() != "") {
                    return true;
                } else {
                ...
                $("#user_email").keyup(function (e) {
                    ...
                    check_email_timer = setTimeout(function () {
                        if (pattern.test(email)) {
                            email_ok = true;
                            $("#check-useremail-result").html("<img src=\"img/available.png\" />");
                        } else {
                            email_ok = false;
                            $("#check-useremail-result").html("<img src=\"img/not-available.png\"/>");
                        }
                    }, 1000);
                });
