                    ...
                    <div class="wrap">
                        ...
                        <div class="grid images_3_of_2">
                            <ul id="etalage">
                                ...
                                <li>
                                    <a href="optionallink.html">
                                        <img class="etalage_thumb_image" src="<%="images/" + ma.getProduct_name() + " (" + i + ")" + ".jpg"%>" class="img-responsive" />
                                        <img class="etalage_source_image" src="<%="images/" + ma.getProduct_name() + " (" + i + ")" + "Copy" + ".jpg"%>" class="img-responsive" title="" />
                                    </a>
                                </li>  
                                <%
                                    }
