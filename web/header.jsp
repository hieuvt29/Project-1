            ...
            <div class="header-bottom-left">
                ...
                <div class="menu">
                    <ul class="megamenu skyblue">
                        ...
                        <li><a class="color5" href="ProductsPageServlet?product=Laptop&supplier=%25" >Laptop</a>
                            <div class="megapanel">
                                <%
                        ...
                        <li><a class="color6" href="ProductsPageServlet?product=Mayanh&supplier=%25" >Máy ảnh</a>
                            <div class="megapanel">
                                <%
